...
if has("gui_running") ||
    ...
    let s:culc_hex="c0c0c0"        " cursor line/column hexadecimal
...
call s:HI(          "Pmenu", s:dblk, s:dwht,     "" )
call s:HI(       "PmenuSel", s:dred, s:lwht,     "" )
call s:HI(         "Visual", s:lwht, s:lblk,     "" )
call s:HI(     "StatusLine", s:dblk, s:lwht, "none" )
call s:HI(   "StatusLineNC", s:lblk, s:lblu, "" )
call s:HI(      "VertSplit", s:lblk, s:dwht,     "" )
call s:HI(        "TabLine", s:dblk, s:dwht, "none" )
call s:HI(    "TabLineFill",     "", s:dblk,     "" )
call s:HI(     "TabLineSel", s:dblk, s:lylw,     "" )
